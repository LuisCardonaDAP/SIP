...
interface MinutaTableProps<TData, TValue> {
      ...
      <CardContent>
        <div className="flex items-center py-4">
          <Input
            ...
            value={(table.getColumn("motivo")?.getFilterValue() as string) ?? ""}
            onChange={(event) =>
              ...
              {table
                ...
                .map((column) => {
                  return (
                    ...
                    >
                      {column.id === 'convoca' ? 'Convoca' :
                       column.id === 'fecha_reunion' ? 'Fecha de Reunión' :
                ...
                <TableRow>
                  ...
                  >
                    {isFiltered
                      ...
                      : "No hay minutas registrados. Cree uno para comenzar."}
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
